...
function openTutorial2() {
  document.querySelector("#tela-tutorial-3").style.display = "flex";
            if (
              /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(
                userAgent
              )
...
function okEntendi() {
  ...
  document.getElementById("tela-tutorial-3").style.display = "none";
}
...
function trocarImagem(passo) {
  ...
  if (
    ...
    imagensGaleria[imagemAtual].imagem == "galeria-09"
  ) {
